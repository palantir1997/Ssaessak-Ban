...
<body class="bg-gray-50 text-gray-800 flex flex-col min-h-screen">
    ...
    <div id="auth-modal" class="hidden fixed inset-0 z-[100] bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
        <div class="bg-white rounded-3xl max-w-md w-full p-6 sm:p-8 shadow-2xl relative border border-gray-100">
            ...
            <form id="modal-login-form" onsubmit="handleMockLogin(event)" class="space-y-5">
                ...
                <div class="space-y-3 pt-2">
                    <div>
                        <label class="block text-xs font-bold text-gray-500 mb-1">인터넷 진료 ID (성함)</label>
                        <input type="text" id="login-id" required placeholder="성함을 입력하세요" class="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-sprout-500">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 mb-1">비밀번호</label>
                        <input type="password" required placeholder="••••••••" class="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-sprout-500">
                    </div>
                </div>
            ...
            <form id="modal-signup-form" onsubmit="return validateSignupForm()" class="space-y-4 hidden">
                ...
                <div class="space-y-2 pt-2 max-h-[350px] overflow-y-auto pr-1">
                    <div>
                        ...
                        <input type="text" required placeholder="홍길동" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-sprout-500">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 mb-1">희망 로그인 ID</label>
                        <input type="text" required placeholder="sprout123" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-sprout-500">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 mb-1">비밀번호 설정</label>
                        <input type="password" id="signup-pw" required placeholder="최소 8자 이상" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-sprout-500">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="tel" required placeholder="010-0000-0000" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-sprout-500">
                    </div>
                </div>
