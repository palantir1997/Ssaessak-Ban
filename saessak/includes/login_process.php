...
mysqli_stmt_bind_param($lock_stmt, 'ss', $user_ip, $user_id);
...
if ($lock_count >= 10) {
    record_intrusion($conn, $user_ip, $user_id, 'Brute Force Attack (계정 잠금)', '고위험');
...
if ($login_success) {
    ...
    echo "<script>alert('✅ 관리자 로그인되었습니다.'); location.href='../dashboard.php';</script>";
    exit();
